...
RUN wget -O /usr/src/jdk-$JAVA_VERSION-linux-x64.tar.gz https://jdy-public-downloads.oss-cn-zhangjiakou.aliyuncs.com/jdk/jdk-$JAVA_VERSION-linux-x64.tar.gz && \
    tar -xvf /usr/src/jdk-$JAVA_VERSION-linux-x64.tar.gz -C /opt && \
